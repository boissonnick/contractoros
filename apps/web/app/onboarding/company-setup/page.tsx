            ...
            {STEPS.filter(s => s.id !== 'complete').map((s, i) => (
              <React.Fragment key={s.id}>
                ...
                <div className={cn(
                  ...
                  s.id === step ? 'bg-white text-brand-600' :
                  i < stepIndex ? 'bg-white/80 text-brand-600' :
            ...
            <div>
              ...
              {logoPreview ? (
                ...
                <button
                  ...
                  className="w-full border-2 border-dashed border-gray-300 rounded-xl p-8 flex flex-col items-center hover:border-brand-400 hover:bg-brand-50/50 transition-colors"
                >
