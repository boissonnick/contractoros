      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <div className="flex items-center gap-3">
            <h1 className="text-2xl font-bold text-gray-900 tracking-tight">{sub.companyName}</h1>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-gray-50 rounded-lg p-3 text-center">
                  <p className="text-2xl font-bold text-gray-900 tracking-tight">{sub.metrics.projectsCompleted}</p>
                  <p className="text-xs text-gray-500">Projects Completed</p>
                </div>
                <div className="bg-gray-50 rounded-lg p-3 text-center">
                  <p className="text-2xl font-bold text-gray-900 tracking-tight">{fmt(sub.metrics.totalPaid)}</p>
