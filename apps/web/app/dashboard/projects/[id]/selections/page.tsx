  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <Card className="p-4 text-center">
          <p className="text-2xl font-bold text-gray-900">{formatCurrency(stats.totalSelected)}</p>
        ...
        <Card className={cn('p-4 text-center', stats.variance >= 0 ? 'ring-1 ring-green-200' : 'ring-1 ring-red-200')}>
          <p className={cn('text-2xl font-bold', stats.variance >= 0 ? 'text-green-700' : 'text-red-700')}>
