  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">Manage your availability and view assignments.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <p className="text-xs text-gray-500 mb-4">Click a date to toggle availability. Blue ring = date-specific override.</p>
