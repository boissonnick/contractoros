  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <h3 className="text-sm font-semibold tracking-tight text-gray-900 mb-3">Monthly Availability</h3>
      ...
      <Card>
        <h3 className="text-sm font-semibold tracking-tight text-gray-900 mb-3">My Assignments</h3>
