      ...
      <div className="p-4 border-b border-gray-100 bg-gray-50">
        <div className="grid grid-cols-3 gap-4 text-center mb-4">
          <div>
            ...
            <p className="text-lg font-semibold text-gray-900 tracking-tight">{formatCurrency(overall.estimatedTotal)}</p>
          </div>
          <div>
            <p className="text-xs text-gray-500 uppercase tracking-wide">Actual</p>
            <p className="text-lg font-semibold text-gray-900 tracking-tight">{formatCurrency(overall.actualTotal)}</p>
          </div>
          <div>
